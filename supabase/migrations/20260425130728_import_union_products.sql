...
-- Generated at 2026-04-25T13:07:28.957Z
-- 158 products across 10 parent categories
-- FX rate used: 1 RUB → 0.03 GEL
-- =============================================================================

-- Parent categories
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('შიდა კარები', 'Interior Doors', 'interior-doors', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('სრიალა ტიხრები', 'Sliding Partitions', 'sliding-partitions', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('კედლის პანელები', 'Wall Panels', 'wall-panels', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('საგარდერობოები', 'Wardrobes', 'wardrobes', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('ბიბლიოთეკები', 'Libraries & Shelves', 'libraries', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('თაროები', 'Shelves', 'shelves', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('მაგიდები', 'Tables', 'tables', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('სარკეები', 'Interior Mirrors', 'mirrors', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('შესასვლელი კარები', 'Entrance Doors', 'entrance-doors', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;
INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
  VALUES ('ფურნიტურა', 'Hardware & Fittings', 'hardware', 0, true, NULL)
  ON CONFLICT (slug) DO NOTHING;

-- Subcategories (children of parent categories, only those with products)
DO $$
DECLARE
  parent_mezhkomnatnye_dveri UUID;
  parent_peregorodki UUID;
  parent_stenovye_paneli_dekorativnye UUID;
  parent_garderobnye_shkafy UUID;
  parent_biblioteki_stellazhi UUID;
  parent_polki UUID;
  parent_stoly UUID;
  parent_interernye_zerkala UUID;
  parent_vhodnye_dveri UUID;
  parent_furnitura_dlya_dverei UUID;
BEGIN
  SELECT id INTO parent_mezhkomnatnye_dveri FROM public.categories WHERE slug = 'interior-doors';
  SELECT id INTO parent_peregorodki FROM public.categories WHERE slug = 'sliding-partitions';
  SELECT id INTO parent_stenovye_paneli_dekorativnye FROM public.categories WHERE slug = 'wall-panels';
  SELECT id INTO parent_garderobnye_shkafy FROM public.categories WHERE slug = 'wardrobes';
  SELECT id INTO parent_biblioteki_stellazhi FROM public.categories WHERE slug = 'libraries';
  SELECT id INTO parent_polki FROM public.categories WHERE slug = 'shelves';
  SELECT id INTO parent_stoly FROM public.categories WHERE slug = 'tables';
  SELECT id INTO parent_interernye_zerkala FROM public.categories WHERE slug = 'mirrors';
  SELECT id INTO parent_vhodnye_dveri FROM public.categories WHERE slug = 'entrance-doors';
  SELECT id INTO parent_furnitura_dlya_dverei FROM public.categories WHERE slug = 'hardware';
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ფარული საღებავი', 'Hidden / Paintable', 'hidden-paintable', 1, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ემალი', 'Enamel', 'enamel', 2, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ხელმისაწვდომი ხარისხი', 'Affordable Quality', 'affordable-quality', 3, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ალუმინი და მინა', 'Aluminum & Glass', 'aluminum-glass', 4, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('3D ზედაპირი', '3D Surface', '3d-surface', 5, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('პივოტი', 'Pivot', 'pivot', 6, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ჩრდილოვანი ნაპრალი', 'Shadow Gap', 'shadow-gap', 7, true, parent_mezhkomnatnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ხის', 'Wooden', 'wooden-partitions', 1, true, parent_peregorodki)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ალუმინი და მინა', 'Aluminum & Glass', 'aluminum-glass-partitions', 2, true, parent_peregorodki)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('სასაკეცი', 'Folding', 'folding-partitions', 3, true, parent_peregorodki)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('თანამედროვე', 'Modern', 'modern-panels', 1, true, parent_stenovye_paneli_dekorativnye)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('3D', '3D Surface', '3d-panels', 2, true, parent_stenovye_paneli_dekorativnye)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('კლასიკა', 'Classic', 'classic-panels', 3, true, parent_stenovye_paneli_dekorativnye)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('სასადილო და სამზარეულო', 'Dining & Kitchen', 'dining-tables', 1, true, parent_stoly)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('საუპენი', 'Coffee', 'coffee-tables', 2, true, parent_stoly)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ფარული', 'Hidden', 'hidden-entrance', 1, true, parent_vhodnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('ტრადიციული', 'Traditional', 'traditional-entrance', 2, true, parent_vhodnye_dveri)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('კარის სახელურები', 'Door Handles', 'door-handles', 1, true, parent_furnitura_dlya_dverei)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('შეჩერებლები', 'Stoppers', 'stoppers', 2, true, parent_furnitura_dlya_dverei)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('პენალები', 'Pocket Cassettes', 'pocket-cassettes', 3, true, parent_furnitura_dlya_dverei)
    ON CONFLICT (slug) DO NOTHING;
  INSERT INTO public.categories (name_ka, name_en, slug, sort_order, is_active, parent_id)
    VALUES ('სამკაულები', 'Hangers', 'hangers', 4, true, parent_furnitura_dlya_dverei)
    ON CONFLICT (slug) DO NOTHING;
END $$;

-- Products (linked to subcategory if available, else parent)
DO $$
DECLARE
  target_cat UUID;
BEGIN
  ...
  INSERT INTO public.products (
    ...
    'FILO-60, Fondo / INVISIBLE', 'FILO-60, Fondo / INVISIBLE', 'skrytaya-dever-pod-pokrasky-v-nalichii',
    'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – грунт. Петли - скрытые INVISTA или OTLAV made in Italy. Замок - магнитный AGB, made in Italy. Размеры – 60/70/80/90 x 200/210/240 см. Опция – алюминиевая кромка (в отделке AL09 Chrome Matt / AL10 Black Matt). Скрытый короб INVISIBLE Усиленный, закаленный алюминий. Фальшкороб – дополнительная жесткость (опция). Суппорты 10 шт. (made in Italy), удобство монтажа (опция). Армирующая сетка от растрескивания штукатурки (опция). Компланарность со стеной при открывании «из проёма» и «в проём». «Маяки» для монтажа гипсокартона. Открывание 180°. Уплотнитель DEVENTER (made in Germany). Отделка – анодировка Серебристый алюминий (AL09 Chrome Matt) / Черный матовый (AL10 Black Matt) / под покраску. РЕКОМЕНДАЦИИ ПО ПОКРАСКЕ КОРОБА', 'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – грунт. Петли - скрытые INVISTA или OTLAV made in Italy. Замок - магнитный AGB, made in Italy. Размеры – 60/70/80/90 x 200/210/240 см. Опция – алюминиевая кромка (в отделке AL09 Chrome Matt / AL10 Black Matt). Скрытый короб INVISIBLE Усиленный, закаленный алюминий. Фальшкороб – дополнительная жесткость (опция). Суппорты 10 шт. (made in Italy), удобство монтажа (опция). Армирующая сетка от растрескивания штукатурки (опция). Компланарность со стеной при открывании «из проёма» и «в проём». «Маяки» для монтажа гипсокартона. Открывание 180°. Уплотнитель DEVENTER (made in Germany). Отделка – анодировка Серебристый алюминий (AL09 Chrome Matt) / Черный матовый (AL10 Black Matt) / под покраску. РЕКОМЕНДАЦИИ ПО ПОКРАСКЕ КОРОБА',
    1500, target_cat, '{"https://www.union.ru/upload/iblock/5ea/2l5ycyfxoef0ihvmtjxl8sivahq0wxuu/FILO_60-FONDO_01-2400x1600.jpg","https://www.union.ru/upload/iblock/e05/b3p3l5n3q23b3b3rb1woqvz1u7nda8pv/invisible-02-1.jpg","https://www.union.ru/upload/iblock/a83/e6n21ouav0j7rk1nhjfr0bii9d43kev2/FILO_60-FONDO-2400x1600.jpg","https://www.union.ru/upload/iblock/4d1/iygm0cc970wogfurs019zjj9o4aavq9t/c491d09b3fe917ce2f0f9a13d12a347f19acba0b.jpg","https://www.union.ru/upload/iblock/719/zbaqs3xdjxpjhpn272pim9vjtqyo32jm/FILO_60-FONDO_2-1600x1600.jpg","https://www.union.ru/upload/iblock/1e3/109w172ai571cm2okposzur6liykt8kw/chameleon-IN-10-invisible_01.jpg","https://www.union.ru/upload/iblock/307/axbug5eu720nul28vt1525xzs1uz9pol/_-_-_-ANSELMI-made-in-Italy.jpg.webp","https://www.union.ru/upload/iblock/acc/qndy3whnicpr02pwf30k8bllxgui0k68/chameleon_new_60Al_Out_2_.jpg"}',
    '{"thickness":"6 см","hinges":"OTLAV (made in Italy) adjustable on 3 axes","lock":"- магнитный AGB, made in Italy","opening_angle":"2","gasket":"DEVENTER (made in Germany)","frame":"– двойной брус","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/skrytaya-dever-pod-pokrasky-v-nalichii'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-paintable';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
  ...
  INSERT INTO public.products (
    ...
    'FILO-60, FONDO / DECO', 'FILO-60, FONDO / DECO', 'filo-60-fondo-deco-43764',
    'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – грунт / эмаль / глянец / шпон / HPL / зеркало. Петли - скрытые OTLAV, made in Italy. Замок - магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Опции – алюминиевая кромка. Короб-моноблок DECO Моноблок, закаленный алюминий. Уникальный итальянский конструктив и дизайн в стиле Art-Deco. Надежное соединение наличников под 45°. Уплотнитель DEVENTER (made in Germany). Уплотнитель в наличнике – идеальное прилегание к стене. Открывание 170°. Отделка – анодировка Серебристый алюминий. Опции: покраска порошковой краской, наличник со стороны короба, добор.', 'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – грунт / эмаль / глянец / шпон / HPL / зеркало. Петли - скрытые OTLAV, made in Italy. Замок - магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Опции – алюминиевая кромка. Короб-моноблок DECO Моноблок, закаленный алюминий. Уникальный итальянский конструктив и дизайн в стиле Art-Deco. Надежное соединение наличников под 45°. Уплотнитель DEVENTER (made in Germany). Уплотнитель в наличнике – идеальное прилегание к стене. Открывание 170°. Отделка – анодировка Серебристый алюминий. Опции: покраска порошковой краской, наличник со стороны короба, добор.',
    2120, target_cat, '{"https://www.union.ru/upload/iblock/2ce/arjxhm10vpd40v8vwx27xqmrg5ft2269/_-Fondo-1600x1600.png","https://www.union.ru/upload/iblock/2a0/vlibocnchlbg5v9gm1w3n0qtpxyp1bhr/_%20сечение%20DECO%20Filo%2060%20alu%20out.png","https://www.union.ru/upload/iblock/acc/qndy3whnicpr02pwf30k8bllxgui0k68/chameleon_new_60Al_Out_2_.jpg","https://www.union.ru/upload/iblock/c6a/rjh22v7qzfl6qzqa1lzhzbzwietaykss/_Planar_OUT_laccato_2.jpg"}',
    '{"thickness":"6 см","hinges":"- скрытые OTLAV, made in Italy","lock":"DECO box with curly platbands in finish - anodized AL09 Chrome Matt (platbands o","max_size":"– 100 х 350 см","opening_angle":"2","gasket":"DEVENTER (made in Germany)","frame":"– двойной брус","made_in":"Italy","model":"Piatto"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/filo-60-fondo-deco-43764'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-paintable';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'FILO-60, Entry, LACCATO GLOSS / INVISIBLE', 'FILO-60, Entry, LACCATO GLOSS / INVISIBLE', 'filo-60-entry-laccato-gloss-invisible',
    'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – эмаль / глянец / шпон. Алюминиевый молдинг на полотне. Петли - скрытые INVISTA или OTLAV made in Italy. Замок - магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Алюминиевая торцевая кромка. Скрытый короб INVISIBLE Усиленный, закаленный алюминий. Фальшкороб – дополнительная жесткость. Суппорты 10 шт. (made in Italy), удобство монтажа. Армирующая сетка от растрескивания штукатурки. Компланарность со стеной при открывании «из проёма» и «в проём». «Маяки» для монтажа гипсокартона. Открывание 180°. Уплотнитель DEVENTER (made in Germany). Отделка – алюминий без покрытия. Опции: анодировка Серебристый алюминий / Черный матовый, покраска порошковой краской. РЕКОМЕНДАЦИИ ПО ПОКРАСКЕ КОРОБА', 'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – эмаль / глянец / шпон. Алюминиевый молдинг на полотне. Петли - скрытые INVISTA или OTLAV made in Italy. Замок - магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Алюминиевая торцевая кромка. Скрытый короб INVISIBLE Усиленный, закаленный алюминий. Фальшкороб – дополнительная жесткость. Суппорты 10 шт. (made in Italy), удобство монтажа. Армирующая сетка от растрескивания штукатурки. Компланарность со стеной при открывании «из проёма» и «в проём». «Маяки» для монтажа гипсокартона. Открывание 180°. Уплотнитель DEVENTER (made in Germany). Отделка – алюминий без покрытия. Опции: анодировка Серебристый алюминий / Черный матовый, покраска порошковой краской. РЕКОМЕНДАЦИИ ПО ПОКРАСКЕ КОРОБА',
    3150, target_cat, '{"https://www.union.ru/upload/iblock/988/3heh1hejpp7p7xn023ujdghn4828ki5b/FILO-60 Bianco Gloss INVISIBLE 2400x1600.png","https://www.union.ru/upload/iblock/863/x8qi594dqxssc2qhoeopiqddfb79j8xv/FILO-60%20Bianco%20Gloss%20INVISIBLE.png","https://www.union.ru/upload/iblock/b2c/1wjpqlkb17kdf7e4mxza0h8sov8fczxt/FILO-Entry-Bianco.jpg","https://www.union.ru/upload/iblock/ec2/4p2wysaetmffo7geoacqpbgpmyf3hgq2/Piatto.png","https://www.union.ru/upload/iblock/acc/qndy3whnicpr02pwf30k8bllxgui0k68/chameleon_new_60Al_Out_2_.jpg","https://www.union.ru/upload/iblock/2a0/vlibocnchlbg5v9gm1w3n0qtpxyp1bhr/_%20сечение%20DECO%20Filo%2060%20alu%20out.png","https://www.union.ru/upload/iblock/c6a/rjh22v7qzfl6qzqa1lzhzbzwietaykss/_Planar_OUT_laccato_2.jpg","https://www.union.ru/upload/iblock/183/8yr3631ka70lm13vdutxddet8krsc58z/Короб%20INVISIBLE-03%20сжат.png.webp"}',
    '{"thickness":"6 см","hinges":"- скрытые INVISTA или OTLAV made in Italy","lock":"- магнитный AGB, made in Italy","max_size":"– 100 х 350 см","opening_angle":"2","gasket":"DEVENTER (made in Germany)","frame":"– двойной брус","made_in":"Italy","model":"Entry"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/filo-60-entry-laccato-gloss-invisible'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-paintable';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'FILO-60, Entry / INVISIBLE', 'FILO-60, Entry / INVISIBLE', 'filo-60-entry-veneer-invisible',
    'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – эмаль / глянец / шпон. Алюминиевый молдинг на полотне. Петли – скрытые INVISTA или OTLAV made in Italy. Замок – магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Опции – алюминиевая кромка. Скрытый короб INVISIBLE Усиленный, закаленный алюминий. Фальшкороб – дополнительная жесткость. Суппорты 10 шт. (made in Italy), удобство монтажа. Армирующая сетка от растрескивания штукатурки. Компланарность со стеной при открывании «из проёма» и «в проём». «Маяки» для монтажа гипсокартона. Открывание 180°. Уплотнитель DEVENTER (made in Germany). Отделка – алюминий без покрытия. Опции: анодировка Серебристый алюминий / Черный матовый, покраска порошковой краской. РЕКОМЕНДАЦИИ ПО ПОКРАСКЕ КОРОБА', 'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – эмаль / глянец / шпон. Алюминиевый молдинг на полотне. Петли – скрытые INVISTA или OTLAV made in Italy. Замок – магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Опции – алюминиевая кромка. Скрытый короб INVISIBLE Усиленный, закаленный алюминий. Фальшкороб – дополнительная жесткость. Суппорты 10 шт. (made in Italy), удобство монтажа. Армирующая сетка от растрескивания штукатурки. Компланарность со стеной при открывании «из проёма» и «в проём». «Маяки» для монтажа гипсокартона. Открывание 180°. Уплотнитель DEVENTER (made in Germany). Отделка – алюминий без покрытия. Опции: анодировка Серебристый алюминий / Черный матовый, покраска порошковой краской. РЕКОМЕНДАЦИИ ПО ПОКРАСКЕ КОРОБА',
    2700, target_cat, '{"https://www.union.ru/upload/iblock/f32/htodo1zf0hzgho5dz713xcjocr04odzb/2-_-ENTRY-Vento.jpg","https://www.union.ru/upload/iblock/720/pzkffw1gs6tbf22kenkyvky523qtqs3t/FILO_60-Entry-Noce-Canaletto-Black-INVISIBLE.jpg","https://www.union.ru/upload/iblock/4d7/nnmk3txltzqcj082exx274wepw5hs8rm/FILO-Entry-Noce-Canaletto_1.jpg","https://www.union.ru/upload/iblock/dc8/uhuwkkv0wi6mjvb9vr9gex9kps7fx541/1-FILO-Vento-Noce-Canaletto.jpg","https://www.union.ru/upload/iblock/72b/cfnglq63ow1buh6p08ccd1fxtvc8hxut/2-FILO-Velino-Noce-Canaletto.jpg","https://www.union.ru/upload/iblock/cc5/ipsy35k10duxmg1447awmcsqc9yljn09/3-FILO-Vetta-Noce-Cnaletto.jpg","https://www.union.ru/upload/iblock/716/p0p8aedu7emfaxaevuv4h3b9cxpllzjy/4-FILO-Valetti-Noce-Canaletto.jpg","https://www.union.ru/upload/iblock/7b5/2siqmv99k8pski41iasl8ooz68u8lf2k/5-FILO-Vezana-Noce-Canaletto.jpg"}',
    '{"thickness":"6 см","hinges":"– скрытые INVISTA или OTLAV made in Italy","lock":"– магнитный AGB, made in Italy","max_size":"– 100 х 350 см","opening_angle":"2","gasket":"DEVENTER (made in Germany)","frame":"– двойной брус","made_in":"Italy","model":"Entry"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/filo-60-entry-veneer-invisible'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-paintable';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'FILO-60, FONDO / PLANAR', 'FILO-60, FONDO / PLANAR', 'filo-60-fondo-planar-14546',
    'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – грунт / эмаль / глянец / шпон / HPL / зеркало. Петли - скрытые OTLAV, made in Italy. Замок - магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Опции – алюминиевая кромка. Короб PLANAR Моноблок, закаленный алюминий. Надежное соединение наличников под 45°. Уплотнитель DEVENTER (made in Germany). Уплотнитель в наличнике – идеальное прилегание к стене. Компланарность полотна с наличниками. Открывание 180°. Отделка – анодировка Серебристый алюминий. Опции: покраска порошковой краской, наличник со стороны короба, добор, вставки в наличники.', 'Полотно FILO-60 Толщина 6 см. Каркас – двойной брус. Отделка – грунт / эмаль / глянец / шпон / HPL / зеркало. Петли - скрытые OTLAV, made in Italy. Замок - магнитный AGB, made in Italy. Максимальные размеры – 100 х 350 см. Опции – алюминиевая кромка. Короб PLANAR Моноблок, закаленный алюминий. Надежное соединение наличников под 45°. Уплотнитель DEVENTER (made in Germany). Уплотнитель в наличнике – идеальное прилегание к стене. Компланарность полотна с наличниками. Открывание 180°. Отделка – анодировка Серебристый алюминий. Опции: покраска порошковой краской, наличник со стороны короба, добор, вставки в наличники.',
    1870, target_cat, '{"https://www.union.ru/upload/iblock/8c2/rpo1gd2i3obqwvlhg28stnbj11kp4y63/PLANAR-_-Lago-01.jpg","https://www.union.ru/upload/iblock/67f/vlevca91u8zj92kseh1jtrkz5ysh5ulo/FILO_60-Fondo-PLANAR-1600x1600.png","https://www.union.ru/upload/iblock/c6a/rjh22v7qzfl6qzqa1lzhzbzwietaykss/_Planar_OUT_laccato_2.jpg","https://www.union.ru/upload/iblock/acc/qndy3whnicpr02pwf30k8bllxgui0k68/chameleon_new_60Al_Out_2_.jpg","https://www.union.ru/upload/iblock/2a0/vlibocnchlbg5v9gm1w3n0qtpxyp1bhr/_%20сечение%20DECO%20Filo%2060%20alu%20out.png"}',
    '{"thickness":"6 см","hinges":"- скрытые OTLAV, made in Italy","lock":"- магнитный AGB, made in Italy","max_size":"– 100 х 350 см","opening_angle":"2","gasket":"DEVENTER (made in Germany)","frame":"– двойной брус","made_in":"Italy","model":"Piatto"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/filo-60-fondo-planar-14546'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-paintable';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'PIVOT-FILO', 'PIVOT-FILO', 'pivot-45-102111',
    '1. Prepare the necessary dimensions of the opening L/ H, taking into account the installation of hinges, according to the recommendations. Attention! By preparing openings for standard door sizes, you save on the cost of doors! 2. The slopes of the opening and the wall should be at the vertical level (without deviations) in the final finish. The top of the opening should be horizontalthe minimum level (without deviations) in the finishing. 3. Floors. The door is installed at the level of the finishing floor. Necessary: - the presence of a clean floor; - the floors should be smooth, without differences.', '1. Prepare the necessary dimensions of the opening L/ H, taking into account the installation of hinges, according to the recommendations. Attention! By preparing openings for standard door sizes, you save on the cost of doors! 2. The slopes of the opening and the wall should be at the vertical level (without deviations) in the final finish. The top of the opening should be horizontalthe minimum level (without deviations) in the finishing. 3. Floors. The door is installed at the level of the finishing floor. Necessary: - the presence of a clean floor; - the floors should be smooth, without differences.',
    3130, target_cat, '{"https://www.bluinterni.ru/upload/iblock/d4d/q2ym2mf6pyi76exf9ld4kqmdwxx37osv/2-_-PIVOT-45-laccato.jpg","https://www.union.ru/upload/iblock/37e/fyne7qzkbumsfhhj4nyux14f3k4su1zl/2-_-PIVOT-45-laccato-1600x1600.jpg","https://www.union.ru/upload/iblock/bcb/xm5u0k6h5w9g0ckxr4214xtlh1kh9i0x/PIVOT_45-Laccato_1.jpg","https://www.union.ru/upload/iblock/8a6/w59i7aajvkvh36hex5oita93cyvq6o10/PIVOT_45-Laccato_2.jpg","https://www.union.ru/upload/iblock/567/j1d1luwbm147yb7zfuo8pc3y9man2w84/PIVOT_-45-Fondo-_3_.jpg","https://www.union.ru/upload/iblock/e37/61vvl32mtwph7h2282uftbxmajuq1ggl/2-_-PIVOT-45-gloss-1600x1600.jpg","https://www.union.ru/upload/iblock/04e/iaju3vbj5wmmmft1fgp24469atfjklme/2-_-PIVOT-45-_-1600x1600.jpg","https://www.union.ru/upload/iblock/617/dugpsqkfnt2opw98fs01si80l69ute85/PIVOT_45-Velino-Noce-Europeo.jpg"}',
    '{"lock":"UNION R11 (RU) Preview","opening_angle":"2","frame":"made of double timber of multilayer solid wood + two HDF panels","material":"HP05 Marmo Grigio","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/pivot-45-102111'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-paintable';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
  ...
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'wardrobes';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    price, category_id, images, specifications,
    is_active, is_new, stock_quantity, source_url
  ...
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'hidden-entrance';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    price, category_id, images, specifications,
    is_active, is_new, stock_quantity, source_url
  ...
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'traditional-entrance';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    price, category_id, images, specifications,
    is_active, is_new, stock_quantity, source_url
  ...
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    price, category_id, images, specifications,
    is_active, is_new, stock_quantity, source_url
  ) VALUES (
    'ROBOT, Cromo', 'ROBOT, Cromo', 'robot-1332',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    140, target_cat, '{"https://www.union.ru/upload/iblock/15b/c0miyara2ef3yb2pw1eu3eu1ngcl5d9x/9215f1a7780ebeb57fc18ef41ba2675d78794a41_2.jpg","https://www.union.ru/upload/iblock/d9c/d23xr1g12oynnqpzpdjrg7gwa0kt63u6/9215f1a7780ebeb57fc18ef41ba2675d78794a41.jpg.webp","https://www.union.ru/upload/iblock/653/3v5bh4dyre0gjsmxn9sygnilby9khnbd/ROBOT_2.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOT"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/robot-1332'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOT, Cromat', 'ROBOT, Cromat', 'robot-1333',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    100, target_cat, '{"https://www.union.ru/upload/iblock/4f1/uceh3nw4rxdna0rxcewfezd1upk00x9w/bf974d597ddb5b10f9887104fcdb1188f5897bda_2.jpg","https://www.union.ru/upload/iblock/8d2/m3gavbff5lfy9hfowabms0hny9nwzqfj/bf974d597ddb5b10f9887104fcdb1188f5897bda.jpg.webp","https://www.union.ru/upload/iblock/2f7/906zenuutb5mu5ri1uj9rqlplnaz2oyw/ROBOT_3.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOT"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/robot-1333'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOT, Oroplus', 'ROBOT, Oroplus', 'robot-1331',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    120, target_cat, '{"https://www.union.ru/upload/iblock/2aa/u7p8le7mvldw3fvetwwebmnrbvhtr6lh/Robot_2.jpg","https://www.union.ru/upload/iblock/bac/3495g9jhi3ffint5qyo2wtw958z5jpi4/87ba911d65fbb5f10f7d7e6d90953f18a5c5f682.jpg.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOT"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/robot-1331'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO, Cromo', 'ROBOQUATTRO, Cromo', 'roboquattro-cromo-5836',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    90, target_cat, '{"https://www.union.ru/upload/iblock/3b9/ut7orbvh6mqd3s615a11px15bni9b32l/Roboqutro-chrom_2.jpg","https://www.union.ru/upload/iblock/f33/hcplyvrr31592j334scyslh5nlkf1xee/Roboqutro-chrom.jpg","https://www.union.ru/upload/iblock/e11/cjl17xw0tk9bry13fw90pn2u7t73hid0/Roboqutro-chrom_1.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-cromo-5836'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO, Cromat', 'ROBOQUATTRO, Cromat', 'roboquattro-1269',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    120, target_cat, '{"https://www.union.ru/upload/iblock/a35/b4rhx0r0ld60x8bpzsv5bbsy2j17jwdu/4af890ad94b9c6610959db059ef48e555559cd32_2.jpg","https://www.union.ru/upload/iblock/ff0/vmp00ja3ewi1pbbfxeh3fei1gbqg8oh0/4af890ad94b9c6610959db059ef48e555559cd32.jpg","https://www.union.ru/upload/iblock/628/rpwf0f4legpjtklf0d1ab9dv0jma50t7/222.jpg","https://www.union.ru/upload/iblock/1da/5hi66i9kvwb0hmvgqpnbntmm2yrzlpzf/Roboqutro-chrom-mat.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-1269'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO, Oromat', 'ROBOQUATTRO, Oromat', 'roboquattro-oromat-5837',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    140, target_cat, '{"https://www.union.ru/upload/iblock/907/k5as4xpdc6nl2jf9lysw9in1o36igrpe/Roboquatro-oro-mat_2.jpg","https://www.union.ru/upload/iblock/5c7/tk9h1dmsaho1k5ljoiaw55c4sz5zkys3/Roboquatro-oro-mat.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-oromat-5837'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO "S", Cromat', 'ROBOQUATTRO "S", Cromat', 'roboquattro-s-hromat-40241',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    350, target_cat, '{"https://www.union.ru/upload/iblock/95e/bc6kyrg53di1wwpvpl09g7lexamea51t/COLOMBO-ROBOQUATTRO-S-_-_-2400x1200.png","https://www.union.ru/upload/iblock/711/pdsd0s5mj7o6ga165ceklu9ev0b7z37n/COLOMBO-ROBOQUATTRO-S-_-_02.png","https://www.union.ru/upload/iblock/57b/zthspkj47hunlwobd0s3w6nfnu206w8z/COLOMBO-ROBOQUATTRO-S-_00.png.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO &quot;S&quot;"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-s-hromat-40241'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO "S", Cromo', 'ROBOQUATTRO "S", Cromo', 'roboquattro-s-hrom-6206',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    130, target_cat, '{"https://www.union.ru/upload/iblock/0f7/qg6x13ty729h1eawdbi3kdtw16ylbp6f/f6bbf0aee9700fc34264f8b917b1646b83c70056_2.jpg","https://www.union.ru/upload/iblock/008/640n23zm7cem3o3y9bce12a3kic9e5ow/COLOMBO-ROBOQUATTRO-S-_02.png","https://www.union.ru/upload/iblock/e8b/lczqkwczzkvzqacyec4i2zfvwwxtg52h/Roboquattro-S_1.jpg","https://www.union.ru/upload/iblock/bab/7o95592w1n596aqp6625hmug6npyxsdv/ROBOQUATTRO_3.jpg","https://www.union.ru/upload/iblock/57b/zthspkj47hunlwobd0s3w6nfnu206w8z/COLOMBO-ROBOQUATTRO-S-_00.png.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO &quot;S&quot;"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-s-hrom-6206'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO "S", Oroplus', 'ROBOQUATTRO "S", Oroplus', 'roboquattro-s-oroplus-40242',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    340, target_cat, '{"https://www.union.ru/upload/iblock/f47/8zt43eyqfunl4ewkwe796hyn21q3mvd1/COLOMBO-ROBOQUATTRO-S-_-2400x1200.png","https://www.union.ru/upload/iblock/93e/00h2bgihqh20a13xpkth1f4qoi8k6ypw/COLOMBO-ROBOQUATTRO-S-_02.png","https://www.union.ru/upload/iblock/e48/6i73ft5wndzg3wo07xindfpx2g8iss1v/COLOMBO-ROBOQUATTRO-S-_00.png.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO &quot;S&quot;"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-s-oroplus-40242'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO "S", Biancomat', 'ROBOQUATTRO "S", Biancomat', 'roboquattro-s-belaya-6207',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    120, target_cat, '{"https://www.union.ru/upload/iblock/899/f9s7hxbu1ugjtfnju9lj4oa8a3gmf41p/89b6e2db17fd0347104192d6b486752ac9133a69_2.jpg","https://www.union.ru/upload/iblock/0e8/s30s0ec5e7kfsdq9zisrh1k9z2uzh4fo/89b6e2db17fd0347104192d6b486752ac9133a69.jpg.webp","https://www.union.ru/upload/iblock/6c9/qo8248smashsg4u03p0z3bj31w8hlvue/954843edba6a8fdeb12df5db629db4de33301c8c.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO &quot;S&quot;"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-s-belaya-6207'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'GIRA, Cromat', 'GIRA, Cromat', 'gira-1334',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    330, target_cat, '{"https://www.union.ru/upload/iblock/3cf/cwgyqakp5vnqp17kfqfjin2jb5hx7oir/d045244fb8bdba4006117f28ba0d5bf6fac2a5c9_2.jpg","https://www.union.ru/upload/iblock/853/2rrvf21st15v3z3iplcjk3fh4ievervk/d045244fb8bdba4006117f28ba0d5bf6fac2a5c9.jpg.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"GIRA"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/gira-1334'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'ROBOQUATTRO "S", Neromat', 'ROBOQUATTRO "S", Neromat', 'roboquattro-s-5663',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    130, target_cat, '{"https://www.union.ru/upload/iblock/c43/o2z99y1azn1bujxhy1jx40vaxto2e4cx/60617816a0891cfb52118595277fec3f2830e512_2.jpg","https://www.union.ru/upload/iblock/06f/uhai98pnky3rnr3ccnlkyp5qdkqdxfmk/60617816a0891cfb52118595277fec3f2830e512.jpg.webp","https://www.union.ru/upload/iblock/45e/rclyj4gmfri1486i14qeqrpv8wwj3rfx/94513966bb654abc2855316af0025fdbe4afa161.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"ROBOQUATTRO &quot;S&quot;"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/roboquattro-s-5663'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'IDA, Cromo', 'IDA, Cromo', 'ida-1328',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    160, target_cat, '{"https://www.union.ru/upload/iblock/288/15abhfpd6h3sp7ta1ik1l16ondrr6n2r/749179870bfe4e7d94901881b91aac80c300040d_2.jpg","https://www.union.ru/upload/iblock/d58/yj9wdrmmmbjtzj46jbda7v9x7xq1mei6/749179870bfe4e7d94901881b91aac80c300040d.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"IDA"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/ida-1328'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'IDA, Oroplus', 'IDA, Oroplus', 'ida-1329',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    180, target_cat, '{"https://www.union.ru/upload/iblock/34b/kmh979o73ptjplyqw7dqyqybykiz0p0v/ab782d65cca26a21adf361379966d507d658ad78_2.jpg","https://www.union.ru/upload/iblock/b15/9l5p6jyd1cq2kb0wys3dsjo0h0kf0jr4/ab782d65cca26a21adf361379966d507d658ad78.jpg.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"IDA"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/ida-1329'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'IDA, Bronzo', 'IDA, Bronzo', 'ida-1330',
    'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.', 'Colombo Design is rightfully the leader among manufacturers of handles for entrance and interior doors. This is achieved by the perfection of technology and cooperation with well-known design studios such as BARTOLI, PININFARINA, CASTILIA, etc. All handles are given a factory warranty of 10 to 30 years.',
    160, target_cat, '{"https://www.union.ru/upload/iblock/ba9/e70aqd0umcqbj78h3yqm382lq3jh3a6z/911ca78ff5b75f62093881c95fddc9c86ec07edb_2.jpg","https://www.union.ru/upload/iblock/514/pzwezb3ilx2a7k8jyi313hrwy3dd6do5/911ca78ff5b75f62093881c95fddc9c86ec07edb.jpg.webp"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"IDA"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/ida-1330'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'NAXOS, Cromo Satinato', 'NAXOS, Cromo Satinato', 'naxos-cromo-satinato-6125',
    'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.', 'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.',
    210, target_cat, '{"https://www.union.ru/upload/iblock/7d0/2n7il69h6c2e2cph22n26xjlqxps71ur/d8a95609e4a6b8608b08a2fa5deeff015ff23fb7_2.jpg","https://www.union.ru/upload/iblock/ceb/jd68yvibjnkcxedpj064m10o0ojr6fwo/d8a95609e4a6b8608b08a2fa5deeff015ff23fb7.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"NAXOS"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/naxos-cromo-satinato-6125'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'NAXOS, Cromo Lucido', 'NAXOS, Cromo Lucido', 'naxos-cromo-lucido-6124',
    'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.', 'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.',
    210, target_cat, '{"https://www.union.ru/upload/iblock/f5f/7smd6n7k3ptpv6a14i53p3l53za4qwck/fe6da3a27b6febd6d23ebcbb87c4e37cb639c942_2.jpg","https://www.union.ru/upload/iblock/757/ly3h0dqxlwh9o0o7kpligza9d7yc6zym/fe6da3a27b6febd6d23ebcbb87c4e37cb639c942.jpg","https://www.union.ru/upload/iblock/5c2/ozzk9zi5wwa6dfeynxabudgdrcuv3jea/naxos_serie_fashion_forme_maniglia_per_porta_su_rosetta_quadrata_frosio_bortolo_design_essenziale_1.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"NAXOS"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/naxos-cromo-lucido-6124'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'NAXOS, Bianco Opaco', 'NAXOS, Bianco Opaco', 'naxos-bianco-opaco-6126',
    'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.', 'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.',
    210, target_cat, '{"https://www.union.ru/upload/iblock/5eb/sbiu1aaf2dyx246rgsv0cqv5gkynplxk/2eed6c5b690a5d04c44bcfd5f347eb43320d4607_2.jpg","https://www.union.ru/upload/iblock/c07/eywc3r6rg8yibqlr3idt2miri80kr0fa/2eed6c5b690a5d04c44bcfd5f347eb43320d4607.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"NAXOS"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/naxos-bianco-opaco-6126'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'NAXOS, Nero Opaco', 'NAXOS, Nero Opaco', 'naxos-nero-opaco-6127',
    'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.', 'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.',
    210, target_cat, '{"https://www.union.ru/upload/iblock/b3f/id75c188305j7dctbah693yqfjanlkr8/cbb81a2176e26c20175123e7064e108cb625b6d0_2.jpg","https://www.union.ru/upload/iblock/270/dchcl37yu6pg2mewq1c9j4m6c0790p9h/cbb81a2176e26c20175123e7064e108cb625b6d0.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"NAXOS"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/naxos-nero-opaco-6127'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'THEMIS, Cromo Lucido', 'THEMIS, Cromo Lucido', 'themis-cromo-lucido-6120',
    'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.', 'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.',
    300, target_cat, '{"https://www.union.ru/upload/iblock/182/wmpytsva2s3o4ac8ql9eh3vgpoq74jxl/9475a8b66a573b91824e690755fc345f882798fa_2.jpg","https://www.union.ru/upload/iblock/580/vbw4of19em7ehqt8col2hxdkcsn2wvbq/9475a8b66a573b91824e690755fc345f882798fa.jpg","https://www.union.ru/upload/iblock/049/rfo0i9ggitu3vh9ichl6in4dzduup4uh/ea00f833196c3c91ddb88d4b1703cc1c5204d92d.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"THEMIS"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/themis-cromo-lucido-6120'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'THEMIS, Oro Lucido', 'THEMIS, Oro Lucido', 'themis-oro-lucido-6121',
    'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.', 'Frosio Bortolo is a company that has been on the market for more than 60 years, produces and sells door and window accessories and owns the prestigious brands Forme® and Class®.',
    370, target_cat, '{"https://www.union.ru/upload/iblock/9af/was2l6llo7xxlg4ehco6eh8ezmzllcob/b4a983fa7094c6f6a5f80eb6781c9c8930b402cb_2.jpg","https://www.union.ru/upload/iblock/872/jtoh3rhg1ggsf9lcx3jd8p8l86f7t8ks/b4a983fa7094c6f6a5f80eb6781c9c8930b402cb.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"THEMIS"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/themis-oro-lucido-6121'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'CINTO Q, Chrome Matt', 'CINTO Q, Chrome Matt', 'cinto-q-chrome-matt-6196',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    160, target_cat, '{"https://www.union.ru/upload/iblock/a32/v34u24pql79muaez81o2lah3uzaakeqr/Cinty_2.jpg","https://www.union.ru/upload/iblock/433/ryhc7m1bi2kb5bykt2vcmagcvxwi4zj8/2c470c8ffaa0005c349b2febea5b4a16256a6d6e.jpg","https://www.union.ru/upload/iblock/18c/xcin5di6zr3ubgw3jjsvmx0gcioddshi/853b8a366d0694ca97812f38c73e7fa3a65ade09.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"CINTO Q"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/cinto-q-chrome-matt-6196'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'CINTO Q, Black', 'CINTO Q, Black', 'cinto-q-black-37735',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    310, target_cat, '{"https://www.union.ru/upload/iblock/a86/ov59muel0vf1cm5fk8akh769l7lyv80b/CINTO-Q_-Black-2400x1200.png","https://www.union.ru/upload/iblock/c12/hlr9dbtnp3d3yum4xynjm5iypynsa5m6/CINTO-Q_-Black_00.png","https://www.union.ru/upload/iblock/f39/914slygsm5cdfp6y2gukfbeehdyjdymj/853b8a366d0694ca97812f38c73e7fa3a65ade09.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"CINTO Q"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/cinto-q-black-37735'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'CINTO Q, White', 'CINTO Q, White', 'cinto-q-white-37742',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    310, target_cat, '{"https://www.union.ru/upload/iblock/13b/gf1jg9svjp095a7wsa9hauyglvxbzx9h/CINTO-Q_-White-2400x1200.png","https://www.union.ru/upload/iblock/244/lu9ldzg08biuap5jcyqzjkwf9ps9ais5/CINTO-Q_-White_00.png","https://www.union.ru/upload/iblock/507/a30f7836tpeyiuwi3oho70rf9wwm2jz6/853b8a366d0694ca97812f38c73e7fa3a65ade09.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"CINTO Q"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/cinto-q-white-37742'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'SQUARE Q, Chrome Matt', 'SQUARE Q, Chrome Matt', 'square-q-chrome-matt-6197',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    160, target_cat, '{"https://www.union.ru/upload/iblock/a80/pbt63q1z9dj4oa0tv10sz54v7cmdd3oi/Tupai_2.jpg","https://www.union.ru/upload/iblock/0d0/myazbq0p58ra700n3k428yky0rqn30o1/93d9d111aa190894110867aeb197ad48f7068683.jpg","https://www.union.ru/upload/iblock/18c/xcin5di6zr3ubgw3jjsvmx0gcioddshi/853b8a366d0694ca97812f38c73e7fa3a65ade09.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"SQUARE Q"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/square-q-chrome-matt-6197'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'SQUARE Q, White', 'SQUARE Q, White', 'square-q-white-37743',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    310, target_cat, '{"https://www.union.ru/upload/iblock/29f/a29zzen442ermf2yi07qbzdo8ky45j5y/2275_q_152_white-2400x1200.jpg","https://www.union.ru/upload/iblock/453/3p6g8c47chij41jdu3kdb92ke1tazxsk/SQUARE-Q_-White_00.png","https://www.union.ru/upload/iblock/507/a30f7836tpeyiuwi3oho70rf9wwm2jz6/853b8a366d0694ca97812f38c73e7fa3a65ade09.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"SQUARE Q"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/square-q-white-37743'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'BIG LINE, Chrome Matt', 'BIG LINE, Chrome Matt', 'big-line-chrome-matt-vstavka-belaya-matovaya-6134',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    300, target_cat, '{"https://www.union.ru/upload/iblock/c33/kl2kfdr5y6w8x4dw5xqzaveu37itxugs/791b8f6da4bbc470f6755e04b1e4fed9fb4c574d_2.jpg","https://www.union.ru/upload/iblock/7e3/fxmwdf8h8zngp6j0omjmyb6c8ogk5atr/791b8f6da4bbc470f6755e04b1e4fed9fb4c574d.jpg","https://www.union.ru/upload/iblock/d16/287dq2t8yckv1lvpp2lnqhffs74prlhs/c79e6d20711713247bba93caaadda288bf569d66.jpg","https://www.union.ru/upload/iblock/511/iz65t5tn5de7bv810edfpvusfla1my6m/7ba47e4bfcf0e48845e19a552ca47bc68b95b0e4.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"BIG LINE"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/big-line-chrome-matt-vstavka-belaya-matovaya-6134'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'SQUARE Q, Black', 'SQUARE Q, Black', 'square-q-black-37744',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    310, target_cat, '{"https://www.union.ru/upload/iblock/5ed/rdltckm4gsvwwdzekmq9izk28gq13p5t/ruchka_tupai-black-2400x1200.jpg","https://www.union.ru/upload/iblock/9df/egy25rzplepqvnv4n5lhb42rji640o9m/SQUARE-Q_-Black_00.png","https://www.union.ru/upload/iblock/507/a30f7836tpeyiuwi3oho70rf9wwm2jz6/853b8a366d0694ca97812f38c73e7fa3a65ade09.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"SQUARE Q"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/square-q-black-37744'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'BIG LINE, Black', 'BIG LINE, Black', 'big-line-black-matt-colour-vstavka-nero-6141',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    300, target_cat, '{"https://www.union.ru/upload/iblock/c74/rg3f7i7ee71zqn587c8hzgqpztjanibw/45cbe725b7f6e3fec026d06f97ba83dc83d11a02_2.jpg","https://www.union.ru/upload/iblock/2f4/h07asp1h3ivmt69r4bd8p5ni5d1sww6e/45cbe725b7f6e3fec026d06f97ba83dc83d11a02.jpg","https://www.union.ru/upload/iblock/1b7/un9yhkksq3570gh42q6dvryxgwuxx38u/9d48ff59f17913313161284b8fc218ad8d054f81.jpg","https://www.union.ru/upload/iblock/de1/6vk2fes3l2k789f1gukosuh4vgt74jry/c7b93bae0df00c423cfe8a3ff9f15123529e6b93.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"BIG LINE"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/big-line-black-matt-colour-vstavka-nero-6141'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'MELODY, Chrome Matt', 'MELODY, Chrome Matt', 'melody-chrome-matt-6132',
    'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap', 'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap',
    310, target_cat, '{"https://www.union.ru/upload/iblock/f05/0ec3hdkg1pq7t4tkwgfb4hcqk5azgyd7/4937742303a813a35bea0c3129bd833e6a6d5dff_2.jpg","https://www.union.ru/upload/iblock/c3f/i8850icknfdon117zru1jorknbmymfe8/4937742303a813a35bea0c3129bd833e6a6d5dff.jpg","https://www.union.ru/upload/iblock/511/iz65t5tn5de7bv810edfpvusfla1my6m/7ba47e4bfcf0e48845e19a552ca47bc68b95b0e4.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"MELODY"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/melody-chrome-matt-6132'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'MELODY, Black', 'MELODY, Black', 'melody-black-matt-colour-6133',
    'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.', 'TUPAI is a Portuguese manufacturer of high-quality fittings and accessories for doors, with the most modern production line in Europe. TUPAI door handles are distinguished by a modern innovative design, a wide choice of base shapes, finishing options and color execution, excellent quality and recognition of thousandsand customers all over the world.',
    310, target_cat, '{"https://www.union.ru/upload/iblock/f0a/qusfbjpi3jf90cpt8n074iwwy6c3wqnh/2cb71acd8fdbd04b11f11f2440e0877581f6bbe7_2.jpg","https://www.union.ru/upload/iblock/9a0/49bkvvxujt3lccmamd1fm28bjipvsfie/2cb71acd8fdbd04b11f11f2440e0877581f6bbe7.jpg","https://www.union.ru/upload/iblock/511/iz65t5tn5de7bv810edfpvusfla1my6m/7ba47e4bfcf0e48845e19a552ca47bc68b95b0e4.jpg"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Portugal","model":"MELODY"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/melody-black-matt-colour-6133'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'MARION, Black', 'MARION, Black', 'marion-black-39324',
    'Model MARION. The set of handles in the finish is anodized in black for one door.', 'Model MARION. The set of handles in the finish is anodized in black for one door.',
    480, target_cat, '{"https://www.union.ru/upload/iblock/653/125nxfkl2pmb0q20takyonqg2udbk7mr/MARION_black-2400x1200.png","https://www.union.ru/upload/iblock/c60/toyvkejau6qul4wu02khytazdyvzggi9/MARION_black_00.png","https://www.union.ru/upload/iblock/309/x3g8ez8qr2sccln00dqj7atqnlm8dwn2/MARION-_00.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"MARION"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/marion-black-39324'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'PUNTO, Black', 'PUNTO, Black', 'punto-black-39330',
    'The PUNTO model has a minimum outlet. The set of handles in the finish is anodized in black for one door.', 'The PUNTO model has a minimum outlet. The set of handles in the finish is anodized in black for one door.',
    210, target_cat, '{"https://www.union.ru/upload/iblock/ce2/y97a03v7ciycc2urs1n59uluzjnz24xw/PUNTO-1205-244-FNO-minimal-2400x1200.png","https://www.union.ru/upload/iblock/80a/jxpjl27k0vb5z2dh819hkcrza4hju4w1/PUNTO-1205-244-FNO-minimal_00.png","https://www.union.ru/upload/iblock/b17/jwa5bisiz9o7cu1qko04l1pi6zavcej3/PUNTO-_00.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"PUNTO"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/punto-black-39330'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'PUNTO, Chrome Matt', 'PUNTO, Chrome Matt', 'punto-chrome-matt-39332',
    'The PUNTO model has a minimum outlet. A set of handles in the finish - anodized in chrome matt (Chrome Matt) for one door.', 'The PUNTO model has a minimum outlet. A set of handles in the finish - anodized in chrome matt (Chrome Matt) for one door.',
    210, target_cat, '{"https://www.union.ru/upload/iblock/dde/m3d0h40njuvokfmgio21hfyc53qgmaow/shop_items_catalog-2400x1200.png","https://www.union.ru/upload/iblock/45b/cwnxwk8z1b8glo8pl1rsraeq2dqn3h6z/shop_items_catalog_image2952_00.png","https://www.union.ru/upload/iblock/643/y43c19gvm62y2zqnkurifgkbap7kb91o/PUNTO-_00.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy","model":"PUNTO"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/punto-chrome-matt-39332'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'PURE, white', 'PURE, white', 'pure-belye-44514',
    'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap', 'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap',
    510, target_cat, '{"https://www.union.ru/upload/iblock/edd/iaj1nr1rts8kj70cmpvs3m05jh1e83uf/Verum-pure-bianco-monviso-2400x1200.png","https://www.union.ru/upload/iblock/411/qfi5gnsw3n16r2w54427ke14a1z634ju/Verum-pure-bianco-monviso-2400x1200.png","https://www.union.ru/upload/iblock/c9a/7gndlsiu9g0nlie7q0fmd4ry2gx3f016/Verum-pure-bianco-monviso-2400x1200.png","https://www.union.ru/upload/iblock/3a5/lbht92hbq56wqxoxy10cbw6g2ia9geat/verum_pure_scheda_tecnica.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/pure-belye-44514'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'PURE, black', 'PURE, black', 'pure-chyernye-44520',
    'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap', 'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap',
    510, target_cat, '{"https://www.union.ru/upload/iblock/6a4/l16nfcwek3xepthffe3d89ftlabfk9zu/Verum-pure-nero-etna-2400x1200.png","https://www.union.ru/upload/iblock/0cd/bd92z4jj2tazj8136w03n5dt99f37h7u/Verum-pure-nero-etna-2400x1200.png","https://www.union.ru/upload/iblock/3ff/y0h2biu4qn36rdgehjk05lok6shsyhn5/Verum-pure-nero-etna-2400x1200.png","https://www.union.ru/upload/iblock/c6d/e21qx19srpcet6gabwi8sc3d7276zmj9/verum_pure_scheda_tecnica.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/pure-chyernye-44520'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'PURE, brushed chrome', 'PURE, brushed chrome', 'pure-khrom-matovyy-44521',
    'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap', 'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap',
    540, target_cat, '{"https://www.union.ru/upload/iblock/477/1yn4cxt3scltt3ornarj0fs1r83kw91y/Verum-pure-cromo-satinato-2400x1200.png","https://www.union.ru/upload/iblock/24a/gxgca0062lp1h7bq04zx800q02l6ih1q/Verum-pure-cromo-satinato-2400x1200.png","https://www.union.ru/upload/iblock/166/ijvje7bago27j2nmgvpkmz36cxtca173/Verum-pure-cromo-satinato-2400x1200.png","https://www.union.ru/upload/iblock/c6d/e21qx19srpcet6gabwi8sc3d7276zmj9/verum_pure_scheda_tecnica.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/pure-khrom-matovyy-44521'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'BAAR, black', 'BAAR, black', 'baar-chyernye-44522',
    'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap', 'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap',
    530, target_cat, '{"https://www.union.ru/upload/iblock/552/0zaxb36kpyohsi6ik6d2fv43p7v41na6/Verum-baar-nero-etna-2400x1200.png","https://www.union.ru/upload/iblock/061/vldaczk1b4je0tnzkfpd00vux80r25cn/Verum-baar-nero-etna-2400x1200.png","https://www.union.ru/upload/iblock/a18/vmqt8ro8q1w53urrshwpe2bse4fnpd5n/Verum-baar-nero-etna-2400x1200.png","https://www.union.ru/upload/iblock/b25/jnw9b8jajibjbzmc6rttgzx4rm229gto/verum_baar_scheda_tecnica.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/baar-chyernye-44522'
  ) ON CONFLICT (slug) DO NOTHING;
  SELECT id INTO target_cat FROM public.categories WHERE slug = 'door-handles';
  INSERT INTO public.products (
    name_ka, name_en, slug, description_ka, description_en,
    ...
    'BAAR, chrome matt', 'BAAR, chrome matt', 'baar-khrom-matovyy-44523',
    'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap', 'Prices and product descriptions are for informational purposes only and are not a public offer! It is PROHIBITED to reprint the pages of the website and their screen images, including the information and materials contained on the website, without permission. Illegal use of trademarks, patents, service marks, posted 14.10 of the Administrative Code of the Russian Federation, 180 of the Criminal Code of the Russian Federation. The photos on the website do not allow you to accurately convey the colors of the tinting, painting, texture and finish of the finished products. *Instagram is a banned social network in Russia. Sitemap',
    560, target_cat, '{"https://www.union.ru/upload/iblock/d9f/66k0t54ms98upy52hj7qh6linmmlrbrb/Verum-baar-cromo-satinato-2400x1200.png","https://www.union.ru/upload/iblock/b6a/qrvb2ik2xwhhmo17zqsr3mqqviv2qn02/Verum-baar-cromo-satinato-2400x1200.png","https://www.union.ru/upload/iblock/af0/x37kbi08ieklu947zo1h2q6urrjsalo1/Verum-baar-cromo-satinato-2400x1200.png","https://www.union.ru/upload/iblock/b25/jnw9b8jajibjbzmc6rttgzx4rm229gto/verum_baar_scheda_tecnica.png"}',
    '{"lock":"!important; }","opening_angle":"2","made_in":"Italy"}'::jsonb,
    true, false, 1, 'https://en.union.ru/product/baar-khrom-matovyy-44523'
  ) ON CONFLICT (slug) DO NOTHING;
...
-- 156 product INSERTs emitted (skipped on slug conflict)
-- 21 subcategories used